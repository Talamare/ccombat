NDefines = {
	...
	NGraphics = {
		...
		MISSILE_ROTATION_RATE		= 15.0, -- how fast missiles will adjust their rotation. High values can cause visible snaps each micro update
		...
		MISSED_BEAM_LENGTH = 300.0, -- how long missed beams will be

		SHIP_DAMAGE_TEXTURE = "gfx/models/ships/other/damaged_noise.dds",
		SHIP_RANDOM_HEIGHT_OFFSET = 30.0,

		RANDOM_HEIGHT_MIN = -30.0,
		RANDOM_HEIGHT_MAX = 30.0,
		...
		MAX_GFX_MISSILES = 50,
		MUZZLE_FLASH_LIMIT = 70,
		MUZZLE_FLASH_DURATION = 1.0,
	},
	...
	NGameplay = {
		...
		SHIP_SUBLIGHT_SPEED_MULT = 7, 				-- General speed multiplier for ship movement within solar systems
		...
		GARRISON_SIZE_MULT					= 0.5,		-- Per pop over 1
		PLANET_FORTIFICATION_BASE			= 500,		-- Planet always has this much fortification health
		PLANET_FORTIFICATION_MULT			= 150,		-- Per pop over 1
		PLANET_FORTIFICATION_DEFENSE_BONUS	= 5,		-- At 100% fortification, divide damage to defending armies by this
		PLANET_FORTIFICATION_DEFENSE_MIN	= 0.8,		-- At 0% fortification, divide damage to defending armies by this
...
--		ETHOS_UNIFORM						= 25,	-- Uniform ethos results in this opinion value
		...
		GROUND_SUPPORT_LIMITED_DMG				= 0.45, -- Multiplier to fortification damage
		...
		NAVY_SIZE_SPACEPORT_BASE							= 7,	-- Base value of Naval Capacity for each spaceport
		NAVY_SIZE_SPACEPORT_MULT							= 3,	-- Mult value of Naval Capacity for each spaceport level ( NAVY_SIZE_BASE + Level * NAVY_SIZE_MULT )
	...
	NShip = {
		...
		MINERAL_MAINTENANCE_MUL				= 0.006,		-- Ship Maintenance Multiplier, Percentage of the cost of the ship
		REPAIR_RATE							= 0.015,		-- Repair rate per day
		REPAIR_COST_MUL						= 0.3,		-- Ship Repair Cost Multiplier, Percentage of the cost of the ship
	...
	NCombat = {
		...
		COMBAT_AREA_MIN_ATTACK_RADIUS			= 0.4,
		...
		COMBAT_BASE_DAYS_UNTIL_EMERGENCY_FTL 	= 15.0,	-- how many days a fleet should be in combat until they can emergency ftl
		...
		DAMAGE_REDUCTION = 50,								-- armor / ( armor + DAMAGE_REDUCTION )
	},
	...
	NEconomy = {
		MILITARY_STATION_MAINTENANCE_MUL	= 0.6,		-- Monthly military station maintenance multiplier
		...
		FLEET_UPGRADE_TIME_COST_MULT		= 0.20,		-- Upgrade fleet cost
		...
		FLEET_UPGRADE_MINERAL_COST_MULT		= 0.6,		
